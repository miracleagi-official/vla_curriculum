...
- Name: vla_curriculum
- Path: E:/work/plan_lecture/vla_curriculum
- Summary: LeRobot SO101 기반 초급/중급 로봇 AI 교육 커리큘럼과 온라인 트랙 초안 문서 저장소
...
- 빌드 명령: 없음 (문서형 저장소)
- 테스트 명령: 없음 (문서형 저장소)
- 검증 권장: Markdown 링크/이미지 경로 수동 점검

## Tests

- 자동 테스트: 없음
- 문서 검증 범위: 링크 유효성, 표/목차 정합성, 트랙 간 용어 일관성
